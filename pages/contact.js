              ...
              <div className="relative">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 shadow-2xl">
                  <img 
                    ...
                    alt="Professional business meeting with manufacturing consultants presenting growth charts and strategic planning"
                  ...
                  <div className="aspect-video bg-gradient-to-br from-white/20 to-white/5 rounded-xl flex items-center justify-center hidden">
