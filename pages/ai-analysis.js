    ...
    <>
      ...
      <main className="bg-gray-900 min-h-screen font-sans">
        ...
        {loading ? (
          ...
          // Service Not Available - Show Coming Soon
          <div className="max-w-6xl mx-auto px-4 py-16">
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl p-12 text-center border-2 border-blue-400">
              <div className="mb-8">
                <div className="inline-flex items-center gap-2 bg-blue-500 text-white px-6 py-3 rounded-full text-lg font-semibold mb-6">
